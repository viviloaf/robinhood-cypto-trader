...
This is a proof of concept Cryptocurrency trader I built to try to automate
some certain rules for buying and selling Bitcoin (or any crypto) using the
Robinhood API as well as some github packages.

So far, I have it successfully run for 30 minutes and created $0.02 of profit.
My current limitation is that sending a query to check if a limit order was fufilled
is broken and my program creates limit calls too quickly for Robinhood.

I have found that Crypto is not a feasable platform for High Frequency Trading.
@author: blue2 (Vivian Nguyen 678 989 9128)
"""
from pyrh_crypto import Trader
import time
import numpy as np

#This is in the format 'robinhood username', 'robinhood password'
trader = Trader('','')
...
def crypto_trader(symbol, length, balance, purchased_price):
    ...
    while True:
           ...
           #print(current_session_data)
            ...
            #This entire section can be cleaned up with a function and inputs
